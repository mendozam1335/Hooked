 ...
 * Prupose: Main class to hold all states and data for those states.
 *  Also handles damdge and what happens when enemy dies
...
public class Enemy2 : Entity
{
    ...
    public override void Awake()
    {
        ...
        playerDetectedState = new E2_PlayerDetectedState(this, stateMachine,"detected", playerDetectedStateData, this);
